    ...
    <main className="min-h-screen bg-gradient-to-b from-[#ABD6B3] via-[#ABD6B3] to-[#ABD6B3] text-white overflow-x-hidden relative">
      ...
      <div className="relative z-10">
        ...
        <div className="fixed top-0 left-1/2 transform -translate-x-1/2 z-40 w-full max-w-3xl px-4">
          <div className="bg-gradient-to-r from-green-700/40
           via-purple-600/40 to-green-400/40 backdrop-blur-sm border border-amber-400/30 rounded-lg p-3 shadow-lg mt-3 hover:shadow-amber-500/30 transition-all duration-300 group hover:scale-[1.02] relative overflow-hidden">
            ...
            <div className="flex items-center justify-between gap-3 relative">
              <div className="flex items-center gap-2.5">
                ...
                <div className="transform transition-all duration-300 group-hover:translate-x-1">
                  ...
                  <p className="text-xs font-semibold text-amber-200/80 group-hover:text-amber-100/90">The gen2 of our NFT collection will be essential to all IslandDAO irl events.</p>
                  <p className="text-xs font-semibold text-amber-200/80 group-hover:text-amber-100/90">Which perks will you choose?</p>
