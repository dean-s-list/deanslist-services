...
function Hero() {
	return (
		...
		<div className="absolute hidden xl:block h-[1452px] w-[377px] bg-[#ABD6B3] rounded-[100%] -top-[20rem] -right-[10rem] -rotate-[15deg] blur-[190px] -z-10"></div>
			...
			{/* Main Title */}
			<h1 className="text-4xl md:text-[60px] md:leading-[70px] font-bold mb-8 text-[#061E1E]">
            ...
            Get Started
				...
				<button className="text-[#061E1E] hidden py-4  px-6 rounded-lg font-medium hover:bg-white hover:text-#061E1E transition md:flex gap-2 items-center">
