...
export default function SignAllTransactionsPage() {
  return (
    <div className="min-h-screen bg-[#010C0C] flex flex-col items-center justify-center p-4">
      <div className="max-w-md mx-auto text-center">
        <h1 className="text-3xl font-bold text-white mb-6">Sign All Transactions</h1>
        <p className="text-gray-300 mb-8">
          Sign multiple transactions securely through the IslandDAO mobile app.
        </p>
